    ...
    private void txtRadioKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRadioKeyPressed
        ...
        if(evt.getKeyChar() == '\n'){
            ...
            if(radio >= 0){
                ...
                lblArea.setText(String.format("%.4f", area));
                lblPerimetro.setText(String.format("%.4f", perimetro));
                
                lblArea.setBorder(BorderFactory.createLineBorder(Color.black));
                lblArea.setForeground(Color.black);

                lblPerimetro.setBorder(BorderFactory.createLineBorder(Color.black));
                lblPerimetro.setForeground(Color.black);
            }
            else{
                lblArea.setText("Error");
                lblArea.setBorder(BorderFactory.createLineBorder(Color.red));
                lblArea.setForeground(Color.red);

                lblPerimetro.setText("Error");
                lblPerimetro.setBorder(BorderFactory.createLineBorder(Color.red));
